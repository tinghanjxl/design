...
public class XMLUtil {
    ...
    //管道，用于将磁盘上文件读入到内存中（Doument）
    SAXReader sAXReader = new SAXReader();
    //Doument对象，在内存中，树状结构（层次）
    Document document;
    //解析XML文件，利用反射生成对象
    public Object getObject(String xMLFileName) throws DocumentException, InstantiationException, IllegalAccessException, ClassNotFoundException {
